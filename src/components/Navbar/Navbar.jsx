                ...
                <div className="flex justify-between items-center gap-4">
                        ...
                        <div className="relative group hidden sm:block">
                            <input type="text" name="recherche" id="recherche" placeholder="Recherche" 
                                ...
                                rounded-full border border-gray-300 px-2
                                py-1 focus:outline-none focus:border-1 focus:border-orange-400
                        ...
                        <button onClick={()=> alert("Ordered not available to yet")}
                        ...
                        >
                        <span className="group-hover:block hidden transition-all duration-200">Ordre</span>
                        <FaCartShopping
        ...
        <div className="flex justify-center">
            <ul className="sm:flex hidden items-center gap-4">
                ...
                <li className="group relative cursor-pointer">
                    <a href="#" className="flex items-center gap-[2px] px-2">Trending Products
                        <span>
                            <FaCaretDown 
